...
const SERVICES = [
  ...
  },
  {
    ...
    desc: "Chatbots inteligentes para WhatsApp, web y redes que responden, califican leads, agendan reuniones y venden, automáticamente.",
    includes: [
      "Bots para WhatsApp, Instagram, web",
      "Integración con tu CRM o sistemas",
      "Respuestas inteligentes con IA",
      "Derivación a humano cuando hace falta",
  ...
  },
  {
    id: "asistentes",
    icon: "flow",
    name: "Asistentes IA conversacionales",
    tag: "IA Generativa",
    tagline: "Asistentes que entienden, deciden y resuelven",
    desc: "Asistentes con IA generativa que mantienen diálogos naturales, recuerdan el contexto y ejecutan tareas complejas dentro de tu operación.",
    includes: [
      "Diseño de flujos conversacionales",
      "Entrenamiento con datos de tu empresa",
      "Integración con bases de conocimiento",
      "Conexión con CRM, ERP, calendarios",
      "Evolución constante del asistente",
    ],
  },
  {
    id: "software",
